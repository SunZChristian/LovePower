...
namespace LovePower.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        private const string DataTablePath = "Assets/LovePower/GameMain/DataTables";
        private const string CSharpCodePath = "Assets/LovePower/GameMain/Scripts/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/LovePower/GameMain/Configs/DataTableCodeTemplate.txt";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "LovePower");
