...
namespace ET.Client
{
    ...
    [EntitySystemOf(typeof(Main3ViewComponent))]
    public static partial class Main3ViewComponentSystem
    {
        [EntitySystem]
        private static void Awake(this Main3ViewComponent self)
        {
        }

        [EntitySystem]
        private static void YIUIBind(this Main3ViewComponent self)
        {
            self.UIBind();
        }
        
        private static void UIBind(this Main3ViewComponent self)
        {
